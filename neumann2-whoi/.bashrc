...
export PYTHONPATH="${PYTHONPATH}:/home/john.cast/dolphin-ai/python-utilities"
...
__conda_setup="$('/home/john.cast/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/john.cast/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/john.cast/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/john.cast/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
export PATH="/home/john.cast/.local/bin:$PATH"
